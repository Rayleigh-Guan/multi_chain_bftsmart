...
/**
 * The KeyLoader interface is used internally by BFT-SMaRt to load signature
 * keys from disk. Developers can use implementations of this
 * interface so that if their application uses key structures similar to the
 * library, these keys can be shared by both the library and
...
public interface KeyLoader {
     ...
     * @throws NoSuchAlgorithmException If the algorithm specified in the
     *                                  configuration does not exist.
     * @throws InvalidKeySpecException  If the key specs are not properly set.
     * @throws CertificateException     If there was an error loading the public key
     *                                  certificate.
     */
     ...
     * 
     * @throws IOException              If there was an error reading the key file.
     * @throws NoSuchAlgorithmException If the algorithm specified by the key does
     *                                  not exist.
     * @throws InvalidKeySpecException  If the key specs are not properly set.
     * @throws CertificateException     If there was an error loading the public key
     *                                  certificate.
