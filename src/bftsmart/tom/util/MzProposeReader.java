...
//         int reqLen = MzProposeBuffer.getInt();
//         if (reqLen > 0) {
//             RequestList Req = new RequestList();
//             ;
//             for (int i = 0; i < mz_propose.reqLen; i++) {
...
//             mz_propose.bundleSliceList.add(batchListItem);
//         }
//         return mz_propose;
//     }
// }
