 ...
 * checkpoint, and the message
 * batches received since the same checkpoint until the present. The state
 * associated with the last
 * checkpoint together with all the batches of messages received so far,
 * comprises this replica
 * current state
 * 
 * @author Joao Sousa
 */
public class StateLog {
     ...
     * application
     * 
     * @param lastCID the consensus ID for the last messages batch delivered to the
     *                application
     */
     ...
     * 
     * @param transState TransferableState object containing the information which
     *                   is used to updated this log
     */
