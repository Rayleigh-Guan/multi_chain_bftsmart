...
public class MzProposeBuilder {
    ...
    public byte[] createMzBatch(List<Mz_BatchListItem> msgs,int numNounces, long timestamp,int numberOfreq, int totalreqSize,
        ...
        for (Mz_BatchListItem msg : msgs) {
            ...
            System.out.println("Stage: makeMzPropose --Mzpropose BatchlistItem: --nd: "+msg.NodeId+" --st: "+msg.StartHeight+" --ed: "+msg.EndHeight+" --uf: "+msg.usedful);
        }
    ...
    public byte[] makeMzPropose(List<Mz_BatchListItem> msgs, List<TOMMessage> list, int numNounces, long timestamp,boolean useSignature) {
