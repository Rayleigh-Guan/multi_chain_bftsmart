...
public class MessageContext implements Serializable {
     ...
     * @param replyServer  ID of the server expected to send a non-hashed reply when
     *                     the clients sends an unordered hashed request.
     ...
     * @param noOp         true if the consensus instance has no operations to
    ...
    /**
     * Returns the ID of the server expected to send a non-hashed reply when the
     * clients sends an unordered hashed request.
     * 
     * @return ID of the server expected to send a non-hashed reply when the clients
     *         sends an unordered hashed request.
     */
    ...
    /**
     * Returns true if the consensus instance has no operations to deliver to the
     * application
     * 
     * @return true if the consensus instance has no operations to deliver to the
     *         application
     */
     ...
     * now supports since the previous commit.
     * It is assumed that the byte array passed to this method is the serialized
     * request associated to the original TOMMessage.
     * 
