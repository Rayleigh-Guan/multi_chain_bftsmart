...
public class MessageFactory {
    ...
    public ConsensusMessage createMzPropose(int id, int epoch, byte[] value) {

        return new ConsensusMessage(MZPROPOSE, id, epoch, from, value);

    }

    public ConsensusMessage createMzBatch(int id, int epoch, byte[] value) {
        return new ConsensusMessage(MZBATCH, id, epoch, from, value);
    }
}
