 ...
 * checkpoint together with all the batches of messages received do far,
 * comprises the sender's
 * current state
 * 
 * @author Joao Sousa
 */
public class DefaultApplicationState implements ApplicationState {
     ...
     * This constructor should be used when there is a valid state to construct the
     * object with
     * 
    ...
    /**
     * Constructs a TansferableState
     * This constructor should be used when there isn't a valid state to construct
     * the object with
     */
